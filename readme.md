...
====================
This fork of [nette/reflection](https://github.com/nette/reflection) was initiated to update requirements and dependencies of the abandoned package to implement it further.\nPlease get it from nette instead of using this!\nNette Reflection: docblock annotations parser and common reflection classes
